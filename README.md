...
4. Добавил Suspense + React.lazy для CreateCardDialog. Выгода - уменьшение размера основного бандла (react-hook-form, 
   zod-resolver и вся логика диалога уезжают в свой файл), а не отложенная загрузка по клику.
5. Добавил Error Boundary